            ...
            <div class="row">
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                        <?php
                        $prosesnews = mysqli_query($koneksi,"select * from tb_news left join tb_profil ON tb_news.id_login = tb_profil.id_login");
                        ...
                        ?>
                            <article class="post format-standard">
                                <div class="post-thumbnail">
                                    ...
                                    <a href="detail_news.php?id=<?php echo $datanews['id_news'];?>" class="overlay"></a>
                                </div><!--/ post-thumbnail -->

                                <header class="entry-header">
                                    <h2 class="entry-title h4">
                                        <a href="detail_news.php?id=<?php echo $datanews['id_news'];?>">
                                            <?php echo $datanews['judul_news'];?>
                                        </a>
                                    </h2>
                                    <span class="byline">Posted by 
                                        <?php echo $datanews['nama_lengkap'];?> - 
                                    </span>
                                ...
                                <div class="entry-content">
                                    ...
                                    <a href="detail_news.php?id=<?php echo $datanews['id_news'];?>" class="more-link">Read more</a>
                                </div><!-- /entry-content -->
