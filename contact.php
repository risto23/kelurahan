...
<head>
    ...
    <title>Kecamatan Panggarangan | Contact</title>
</head>
            ...
            <div class="row">
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                        <?php
                        $proseskec = mysqli_query($koneksi,"select * from tb_hubkami left join tb_profil ON tb_hubkami.id_login = tb_profil.id_login LIMIT 1");
                            ...
                            <article class="post format-standard mb-40">
                                <header class="entry-header">
                                    ...
                                    <span class="posted-on">
                                        <?php echo fungsi_tgl($datakec['date_hubkami']);?>
                                    </span>
                                </header><!-- /header -->
                               <aside class="widget widget_contact">
                                    <ul>
                                        <li>
                                            ...
                                            <?php echo $datakec['nama_hubkami'];?>
                                        </li>
                                        <li>
                                            <i class="fa fa-map-marker"></i>
                                            <?php echo $datakec['alamat_hubkami'];?>
                                        </li>
                                        <li>
                                            <i class="icon icon-phone"></i><?php echo $datakec['telp_hubkami'];?>
                                        </li>
                                        <li>
                                            <i class="icon icon-paper-plane"></i>
                                            <?php echo $datakec['email_hubkami'];?>
                                        </li>
                                    </ul>
                                </aside>
                            </article><!-- /post -->
