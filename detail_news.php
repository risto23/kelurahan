            ...
            <div class="row">
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        ...
                        <?php
                        $id= $_GET['id'];
                        $prosesnews = mysqli_query($koneksi,"select * from tb_news left join tb_profil ON tb_news.id_login = tb_profil.id_login where tb_news.id_news = '$id'");
