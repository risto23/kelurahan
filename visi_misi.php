...
<head>
    ...
    <title>Kecamatan Panggarangan | Visi Misi</title>
</head>
            ...
            <div class="row">
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                        <?php
                        $proseskec = mysqli_query($koneksi,"select * from tb_visimisi left join tb_profil ON tb_visimisi.id_login = tb_profil.id_login LIMIT 1");
                            ...
                            <article class="post format-standard mb-40">
                                <header class="entry-header">
                                    ...
                                    <span class="posted-on">
                                        <?php echo fungsi_tgl($datakec['date_visimisi']);?>
                                    </span>
                                </header><!-- /header -->
                                <div class="entry-content">
                                    <?php echo $datakec['desc_visimisi'];?>
                                </div><!-- /entry-content -->
                            </article><!-- /post -->
                        <?php  
                        }
